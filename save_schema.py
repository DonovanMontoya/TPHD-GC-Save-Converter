...
GC_FIELDS: tuple[FieldDef, ...] = (
    ...
    FieldDef("player.status_a.select_items", 0x00B, 4, "bytes", "known", "GC uses X/Y in first two slots"),
    FieldDef("player.status_a.mix_items", 0x00F, 4, "bytes", "known"),
    FieldDef("player.status_a.equipment", 0x013, 6, "bytes", "known"),
    ...
    FieldDef("player.return_place", 0x058, 0x0C, "struct", "known"),
    ...
    FieldDef("player.collect", 0x100, 0x10, "struct", "known"),
    FieldDef("player.wolf", 0x110, 0x04, "struct", "known"),
    ...
    FieldDef("event_flags", 0x7F0, 0x100, "bytes", "known"),
...
TPHD_FIELDS: tuple[FieldDef, ...] = (
    ...
    FieldDef("player.status_a.select_items", 0x00D, 4, "bytes", "observed", "Shifted +2 from GC layout; 4 current item slots"),
    FieldDef("player.status_a.mix_items", 0x011, 4, "bytes", "observed", "Shifted +2 from GC layout"),
    FieldDef("player.status_a.equipment", 0x015, 6, "bytes", "observed", "Shifted +2 from GC layout"),
    ...
    FieldDef("player.collect", 0x100, 0x10, "struct", "observed"),
    FieldDef("player.wolf", 0x110, 0x04, "struct", "observed"),
